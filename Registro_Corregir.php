...
?>
		...
		<?php function pregunta_1($detalle){ ?>			
			<div class="div_main" style="margin: 10px 0 0 0;"><?php echo $detalle; ?></div>
			<div style="background: #2E86C1; color: white; padding: 0 6px;">
		...
		<?php function pregunta_3($detalle){ ?>			
			<div class="div_main" style="background: #2E86C1; color: white; margin: 10px 0 0 0;"><?php echo $detalle; ?></div>
			<div style="background: lightblue; color: black; padding: 0 6px;">
...
<?php 	$Desarollo_Proyecto = [
		...
		<?php function pregunta_27c($detalle){ ?>			
			<div class="div_main" style="margin: 10px 0 0 0;"><?php echo $detalle; ?></div>
			<div style="background: #2E86C1; color: white; padding: 0 6px;">
...
<?php 	$municipiosDeSonora = [
		...
		<?php function pregunta_28($detalle){ ?>			
			<div class="div_main" style="margin: 10px 0 0 0;"><?php echo $detalle; ?></div>
			<div style="background: #2E86C1; color: white; padding: 0 6px;">
		...
		<?php function pregunta_29($detalle){ ?>			
			<div class="div_main" style="margin: 10px 0 0 0;"><?php echo $detalle; ?></div>
			<div style="background: #2E86C1; color: white; padding: 0 6px;">
		...
		<?php function pregunta_36($detalle){ ?>			
			<div class="div_main" style="margin: 10px 0 0 0;"><?php echo $detalle; ?></div>
			<div style="background: #2E86C1; color: white; padding: 0 6px;">
